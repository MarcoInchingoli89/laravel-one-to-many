...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap shadow px-3">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Boolfolio Laravel</a>
        ...
        <div class="nav-item dropdown text-white me-5 pe-5">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-5 sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link ms_nav-link {{ Route::currentRouteName() === 'dashboard' ? 'active' : '' }}"
